...
CREATE POLICY "Users can view conversations of their assistants"
...
CREATE POLICY "Users can create conversations for their assistants"
...
CREATE POLICY "Users can update conversations of their assistants"
...
CREATE INDEX idx_business_hours_assistant_id ON public.business_hours(assistant_id);
CREATE INDEX idx_auto_responses_assistant_id ON public.auto_responses(assistant_id);
CREATE INDEX idx_bot_settings_assistant_id ON public.bot_settings(assistant_id);
